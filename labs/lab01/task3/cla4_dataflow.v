...
module cla4_dataflow(
  ...
  assign #(2) g    = a & b;
  assign #(2) c1   = g[0] | (p[0] & cin);
  assign #(2) c2   = g[1] | (g[0] & p[1]) | (p[1] & p[0] & cin);
  assign #(2) c3   = g[2] | (g[1] & p[2]) | (g[0] & p[1] & p[1]) | (p[2] & p[1] & p[0] & cin);
  assign #(2) cout = g[3] | (g[2] & p[3]) | (g[1] & p[2] & p[3]) | (g[0] & p[1] & p[2] & p[3]) | (p[0] & p[1] & p[2] & p[3] & cin);
  assign #(2) sum  = p ^ {c3, c2, c1, cin};
